...
gulp.task('minify', function () {
    ...
    gulp.src(['./assets/layouts/**/scripts/*.js','!./assets/layouts/**/scripts/*.min.js','!./assets/layouts/global/scripts/quick-sidebar.js']).pipe(uglify()).pipe(rename({suffix: '.min'})).pipe(gulp.dest('./assets/layouts/'));
});
