 ...
 * library if you wish.
 * Source: https://raw.githubusercontent.com/clickatell/clickatell-java/master/ClickatellRest.java
 *
 * @author Dominic Schaff <dominic.schaff@gmail.com>
 * @date Dec 2, 2014
 */
@SuppressWarnings({"Duplicates", "ForLoopReplaceableByForEach", "unused"})
public class ClickatellRest {
     ...
     * @param dataPacket The data you want to send via the POST.
    ...
    public class Message {
        String number = null, message_id = null, content = null,
